<?php
	...
	$u_id=$_SESSION["u_id"];
	$que="select * from student_reg where u_id='$u_id'";
...
<body>
	<div class="header" >
		...
		<li><a href="logout.php">Logout</a></li>
 		...
 		<li><a href="exam.php">Online Test</a></li>
	...
	<div class="content" align="center">
		...
		<img style="height:220px;width:220px" src="images/students/<?php echo $row["photo"] ?>"/>
		</div>
