...
<body>
	...
	<div class="stu_reg" align="center">
		...
		<?php
			...
			$query1="INSERT INTO student_reg(sname,father_name,dob,dor,sex,location,address,pincode,u_email,contact_no,u_id,photo) values('$name','$father','$dob','$dor','$sex','$location','$address','$pincode','$uemail','$contactno','$uid','$pic')";
